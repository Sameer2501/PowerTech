...
import rny from '../assets/rny.jpg';
    ...
    <>
      <style>{`
        ...
        @media (max-width: 900px) {
          ...
          .tech-groups-sec { grid-template-columns: 1fr; gap: 40px; }
        }
      `}</style>
      ...
      <section className="tech-groups-sec">
        <div className="tech-groups-image-col">
          <img src={map} alt="Technology Map" className="tech-groups-banner" />
        </div>
        <div className="tech-groups-text-col">
          {/* <h3>Voltage Regulation Systems</h3> */}
          <p>
            The applications for Super Power Tech's voltage regulating transformers fall into two basic groups: maintaining constant output levels by compensating automatically for supply voltage variations, and providing smoothly variable output voltage for heavy-duty industrial processes.
          </p>
          <p>
            Our Automatic Voltage Controllers and Silicon Power Rectifiers fall into these categories, reliably holding voltage, current, power, and temperature constant for various applications without affecting the waveform or power factor.
          </p>
          <p>
